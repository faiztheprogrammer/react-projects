  ...
  let data = [
    {
      ...
      description: "Extensive use of technology is changing the way we work and operate. Know how!"
    },

    {
      id: 2,
      title: "How looking for external validation weakens a man?",
      description: "Modern dilemna of our time is to seek external validation at scale."
    },

    {
      id: 3,
      title: "This is how psychological pressure at a younger age shapes our adulthood",
      description: "One of the great tragedies of our lives is to be pressured so much one is pushed to the edge"
    },
  ]
